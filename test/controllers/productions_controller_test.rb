...
class ProductionsControllerTest < ActionController::TestCase
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post :create, production: { material_id: @production.material_id, product_id: @production.product_id, quantity: @production.quantity, unit: @production.unit }
    end
  ...
  test "should update production" do
    patch :update, id: @production, production: { material_id: @production.material_id, product_id: @production.product_id, quantity: @production.quantity, unit: @production.unit }
    assert_redirected_to production_path(assigns(:production))
  end
